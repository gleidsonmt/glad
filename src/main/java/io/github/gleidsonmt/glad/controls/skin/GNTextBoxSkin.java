 ...
 */
public class GNTextBoxSkin extends SkinBase<TextBoxOld> {
...
//        Platform.runLater(() -> control.setEditor(base.getEditor()));
    ...
    private void bind(@NotNull TextBoxOld editor) {
        ...
        if (control.getIcon() != null && control.getIcon() != Icon.NONE) {
            base.setLeftNode(iconContainer);
        ...
        if (control.getText() != null && !control.getText().isEmpty() && control.isAction()) {
        ...
        if (control.getCount() > 0) {
            ...
            Platform.runLater(() -> base.getEditor().maxProperty().bindBidirectional(counterLabel.maxProperty()));
