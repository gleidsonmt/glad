...
public abstract class CircleLoader extends VBox implements SuspenseLoader {
    ...
    public CircleLoader(String _title, String _legend) {
        ...
        this.getStyleClass().add("circle-loader");
        //
        ...
        this.getStylesheets().add(Resources.getAgent("suspense-circle.css"));
    }
    ...
    protected void rotate(Circle circle) {
        rotate(circle, 360, 2, false, Point3D.ZERO);
    }

    protected void rotate(Circle circle, int angle, Point3D point3D) {
        rotate(circle, angle, 5, true, point3D);
    }
